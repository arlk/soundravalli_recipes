...
def get_recipe_snippets():
    mapping = [
        ...
        {"name": "coconut_burfi", "page": 11, "top": 0, "bottom": 0.3},
        {"name": "rava_badam_laddu", "page": 11, "top": 0.3, "bottom": 1.0},
        ...
        {"name": "sambar_powder_batch_3", "page": 16, "top": 0, "bottom": 0.4},
        {"name": "rasam_powder_batch_2", "page": 16, "top": 0.4, "bottom": 0.7},
        {"name": "kari_masala_powder", "page": 16, "top": 0.7, "bottom": 1.0},
        {"name": "gobi_manchurian", "page": 17, "top": 0, "bottom": 1.0},
        {"name": "vegetable_mandi", "page": 18, "top": 0, "bottom": 1.0},
        {"name": "cold_cucumber_soup", "page": 19, "top": 0, "bottom": 0.5},
...
def crop_snippets():
    ...
    for item in mapping:
        ...
        if top > 0: top = max(0, top - 20)
        if bottom < h: bottom = min(h, bottom + 20)
